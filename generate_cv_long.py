"""[VERSION LONGUE, 2 pages] Generate Julien Rabault's CV as a clean, ATS-friendly one-page PDF (FR). v9
...
EXPERIENCE = [
    {
        ...
        "bullets": [
            ...
            "code Python via FastMCP), en human-in-the-loop.",
...
def build_cv():
    output = os.path.join(BASE, "CV_JULIEN_RABAULT_LONG.pdf")
